...
label talk_mothertree_choice1:
    mt "GO AWAY HUMAN GO AWAY HUMAN"
    menu:
...
label talk_mothertree_choice12:
    mt "HUMANS MEAN PAIN PAIN PAIN"
    mc "Who hurt you?"

    mt "HUMANS IN LONG WHITE ROBES"
...
label talk_mothertree_choice2:
    mt "DOCTORR BETRAYED ME DOCTOR ALLOWED HUMANS TO HURT"

    # (!) Only if Email
    mc "They never wanted to leave you. The other humans hurt them too."
    mt "DOCTOR WAS HURT HUMANS HURT DOCTOR"
...
label talk_mothertree_choice21:
    mt "HUMANS KILLED THE ONLY NICE ONE HUMANS NEED TO DIE"

    jump bad_ending
    return

label talk_mothertree_choice22:
    mt "I WANT TO KNOW WHAT HAPPENED TO DOCTOR"
    ...
    mt "THEY THOUGHT I COULD LIVE WITH HUMANS"
